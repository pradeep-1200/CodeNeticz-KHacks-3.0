...
const Register = () => {
  ...
  const handleRegister = (e) => {
    ...
    if (role === 'student') {
      ...
      // For now, redirect teacher to landing or same dashboard since teacher pages aren't full scope
      alert("Teacher Account Created! Redirecting to demo dashboard...");
      navigate('/student/dashboard'); 
    }
  };
                    ...
                    {role === 'student' && (
                        <div>
                            ...
                            <input 
                                ...
                                placeholder="Enter 6-digit code if you have one"
                            />
                        </div>
                    )}

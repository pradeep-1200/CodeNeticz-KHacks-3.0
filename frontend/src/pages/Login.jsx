...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        // Check the role returned from backend
      ...
      <div className="w-full max-w-md bg-[var(--bg-primary)] p-8 rounded-2xl shadow-xl border border-[var(--border-color)] relative">
        ...
        <div className="flex p-1 bg-[var(--bg-secondary)] rounded-xl mb-2">
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all ${userType === 'student'
          ...
          <button
            ...
            className={`flex-1 py-2 rounded-lg text-sm font-semibold transition-all ${userType === 'teacher'
                ? 'bg-[var(--accent-primary)] text-white shadow-md'
                : 'text-[var(--text-secondary)] hover:text-[var(--text-primary)]'
              }`}
          >

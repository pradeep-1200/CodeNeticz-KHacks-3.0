            ...
            <div className="max-w-2xl mx-auto bg-[var(--bg-primary)] p-8 rounded-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            className="w-full p-3 rounded-xl border border-[var(--border-color)] bg-[var(--bg-primary)] focus:ring-2 focus:ring-[var(--accent-primary)] outline-none resize-none"
                    ...
                    <div className="flex gap-4 mt-6">
                        ...
                        <button type="submit" className="flex-1 py-3 bg-[var(--accent-primary)] text-white rounded-xl font-bold hover:bg-[var(--accent-hover)] transition-colors">
                            Create Class
                        </button>
                    </div>
                </form>
